...
Word Master 1.0.0 for iOS starts in guest study mode and offers optional email login after a round.
...
Primary flow for review:

1. Open the app.
2. Complete a round of 10 questions.
3. Review the result screen and tap `다시 풀기`.
4. Optional: tap `로그인하고 기록 이어가기` to open the email auth screen.

If you need support during review, contact `injooinjoo@gmail.com`.
