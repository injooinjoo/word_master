...
export const vocabBatch41: VocabItem[] = [
  ...
  word('intellectual', '지적인', 4, 'adjective',
    ['약한, 깨지기 쉬운', '약간의; 주변의', '낭비적인', '온라인의', '~하기 쉬운', '침착한, 냉담한, 무기력한', '가장 좋아하는', '깊은', '맛있는 / 매우 아름다운, 매력적인', '나이든, 연로한'],
    tips({
  ...
  word('intense', '강렬한', 7, 'adjective',
    ['급격한', '압도적인, 굉장한', '영원한', '기능장애적인, 고장난', '습관적인', '쓸모없게 된; 쓰이지 않는', '이러한', '인상 깊게 생각하는, 감명을 받은', '비례하는', '정치의'],
    tips({
  ...
  word('intent', '의향', 4, 'noun',
    ['작고 유용한 도구', '만연, 보급', '고칠 수 없음/선도, 개선할 수 없는 상태', '변동', '가치 하락, 화폐의 구매력 저하\n(depreciate : ~의 가치를 떨어뜨리다, 가치가 떨어지다)', '자동차', '집토끼', '더러움, 누추함 / 천함, 비열함', '전쟁', '명성, 명망'],
    tips({
  ...
  word('interest', '흥미', 6, 'noun',
    ['거짓말쟁이', '시계', '갈망, 열망', '조급함', '거리, 간격', '파멸, 운명', '청결', '그래프, 도표', '스펀지', '보험'],
    tips({
  ...
  word('interpret', '해석하다', 7, 'verb',
    ['결정하다', '요청하다', '설명하다', '관리하다', '보완하다', '분석하다', '정리하다', '무릎 꿇다', '건조시키다', '불평하다'],
    tips({
  ...
  word('interval', '간격', 5, 'noun',
    ['몰래 행동하는 사람', '에드거 (남성 이름)', '봄,용수철', '결점, 단점', '장비', '독수리', '거만하게 걷다 / 버팀목', '찰칵, 딱 하는 소리', '증거', '조정'],
    tips({
  ...
  word('intimate', '친밀한', 6, 'adjective',
    ['예외적인', '안정적인', '불안정한', '근거 없는', '말의', '최대의, 극도의', '[살쪄서] 둥근 모양의', '군의', '순이론가, 독단적인', '동시의'],
    tips({
  ...
  word('intrigue', '음모', 8, 'noun',
    ['한계', '원고', '딸기', '마이크 (남성 이름)', '캐시 (여성 이름)', '유산, 문화유산', '청중', '요리사', '인식, 인지', '가려움, 가렵다'],
    tips({
  ...
  word('introduce', '소개하다', 2, 'verb',
    ['마련하다', '믿다', '강등시키다', '비난하다', '(조건으로서) 요구하다', '활력을 없애다, 바보로 만들다 / 무효로 하다', '명확히 하다', '~인 척하다', '화나게하다, 초조하게 만들다', '속삭이다'],
    tips({
  ...
  word('invest', '투자하다', 5, 'verb',
    ['벗기다', '오르다', '만들었다 (make의 과거)', '선택하다', '결정하다', '요청하다', '설명하다', '관리하다', '보완하다', '분석하다'],
    tips({
  ...
  word('investigate', '조사하다', 6, 'verb',
    ['정리하다', '다루다', '~이었다', '애지중지하다 / 응석받이로 키우다', '~와 협력하다', '앞서다', '폭로하다, 정체를 밝히다', '(법률을) 제정하다, 시행하다', '꾸짖다, 비난하다', '확대하다'],
    tips({
  ...
  word('invite', '초대하다', 3, 'verb',
    ['(법률을) 제정하다, 시행하다', '시간을 보내다, 어울려 놀다', '(있어야할 곳을 벗어나) 헤매다', '선택하다', '결정하다', '요청하다', '설명하다', '관리하다', '보완하다', '분석하다'],
    tips({
  ...
  word('isolate', '고립시키다', 7, 'verb',
    ['(자금, 물건 등을) 책정하다', '잡다', '공격하다', '함께 먹다, 함께 하다', '순항하다', '선택하다', '결정하다', '요청하다', '설명하다', '관리하다'],
    tips({
  ...
  word('item', '조항', 4, 'noun',
    ['참나무', '무력/타성/관성', '선물, 현재', '결합, 응집력', '상표', '향기, 향', '날카로움, 선명함', '성가대', '디스켓', '자세'],
    tips({
  ...
  word('jar', '항아리', 6, 'noun',
    ['추방자', '신비, 불가사의', '피난처', '깊은 원한, 적의', '물질', '달력', '수업', '추측\n(speculate, suppose, guess, infer 추측하다)', '곤경, 궁지', '신부'],
    tips({
  ...
  word('journey', '여행', 5, 'noun',
    ['테니스', '유연성, 융통성', '시각화', '아마추어', '역겨움, 혐오감', '정지, 멈춤', '시대착오', '달래려고 준 것 / 뇌물', '야바위/속임수', '허리'],
    tips({
