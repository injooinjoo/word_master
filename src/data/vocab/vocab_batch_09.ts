...
export const vocabBatch09: VocabItem[] = [
  word('abolish', '폐지하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['absolve', 'absorb', 'abode'],
      definitionDistractors: [
        'to officially approve a new law or regulation',
        'to gradually reduce the impact of a policy over time',
        'to temporarily suspend operations of an organization'
      ],
      exampleSentences: [
  ...
  word('absorb', '흡수하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['abscond', 'absolve', 'abstruse'],
      definitionDistractors: [
        'to spread a substance evenly across a flat surface',
        'to remove impurities from a liquid through filtration',
        'to convert solid matter into a gaseous state'
      ],
      exampleSentences: [
  ...
  word('abstract', '추상적인', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['abstain', 'abstruse', 'abreast'],
      definitionDistractors: [
        'describing something that is overly simplified or reduced to its basic elements',
        'relating to a summary or brief overview of a longer document',
        'being disconnected from practical applications or real-world use'
      ],
      exampleSentences: [
  ...
  word('accurate', '정확한', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['accrued', 'accuse', 'acute'],
      definitionDistractors: [
        'happening at regular intervals without any variation',
        'based on personal judgment rather than established facts',
        'providing an excessive amount of unnecessary detail'
      ],
      exampleSentences: [
  ...
  word('acknowledge', '인정하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['acquaint', 'accolade', 'acumen'],
      definitionDistractors: [
        'to formally introduce oneself to a new group of people',
  ...
  word('acquire', '획득하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['acreage', 'acquit', 'accrue'],
      definitionDistractors: [
        'to release ownership of property or assets to another party',
        'to carefully inspect goods before placing a purchase order',
        'to formally register a complaint with a governing body'
      ],
      exampleSentences: [
  ...
  word('adapt', '적응하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['adept', 'adopt', 'adorn'],
      definitionDistractors: [
        'to create a new version of an existing product or design',
        'to formally approve changes to an official document',
        'to transfer skills from one person to another through training'
      ],
      exampleSentences: [
  ...
  word('adequate', '충분한', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['adjacent', 'adulate', 'advocate'],
      definitionDistractors: [
        'exceeding the required standard by a significant margin',
        'being precisely measured to meet exact specifications',
        'temporarily meeting a need until a permanent solution is found'
      ],
      exampleSentences: [
  ...
  word('adopt', '채택하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['adore', 'adapt', 'adobe'],
      definitionDistractors: [
        'to modify an existing plan to better suit current needs',
        'to officially register a new member into an organization',
        'to provide financial sponsorship for a community project'
      ],
      exampleSentences: [
  ...
  word('advocate', '옹호하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['avocado', 'advance', 'advent'],
      definitionDistractors: [
        'to act as a legal representative in a court proceeding',
        'to donate resources to a charitable organization',
        'to negotiate terms between two disagreeing parties'
      ],
      exampleSentences: [
  ...
  word('affect', '영향을 미치다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['effect', 'afflict', 'affirm'],
      definitionDistractors: [
        'to display emotions in an exaggerated or theatrical manner',
        'to formally attach a document to an official record',
  ...
  word('afford', '~할 여유가 있다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['affront', 'affirm', 'afoot'],
      definitionDistractors: [
        'to provide financial assistance to someone in need',
        'to calculate the total cost of a planned purchase',
  ...
  word('aggressive', '공격적인', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['aggregate', 'aggrieve', 'aghast'],
      definitionDistractors: [
        'moving quickly and with great physical energy',
        'showing extreme enthusiasm and excitement about a topic',
        'being highly competitive in a fair and sportsmanlike manner'
      ],
      exampleSentences: [
  ...
  word('allocate', '배분하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['alleviate', 'allude', 'allegory'],
      definitionDistractors: [
        'to physically move resources from one location to another',
        'to increase the total amount of available funding',
        'to determine the exact cost of a planned expenditure'
      ],
      exampleSentences: [
  ...
  word('alter', '변경하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['altar', 'albeit', 'allure'],
      definitionDistractors: [
        'to completely replace one system with an entirely new one',
        'to restore something to its original condition after damage',
        'to carefully examine an object for signs of wear or defects'
      ],
      exampleSentences: [
  ...
  word('alternative', '대안', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['altercation', 'altitude', 'altruism'],
      definitionDistractors: [
        'a backup plan used only in emergency situations',
        'the process of switching between two different methods',
        'a mandatory requirement that must be fulfilled without exception'
      ],
      exampleSentences: [
  ...
  word('anticipate', '예상하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['antecedent', 'antiquate', 'antidote'],
      definitionDistractors: [
        'to react quickly to an event that has already occurred',
        'to deliberately delay action until more information is available',
        'to recall past events with great accuracy and detail'
      ],
      exampleSentences: [
  ...
  word('appetite', '식욕', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['aptitude', 'aperture', 'appendix'],
      definitionDistractors: [
        'the ability to taste and distinguish between different flavors',
        'a specific type of diet designed for health improvement',
        'the process of preparing and cooking a elaborate meal'
      ],
      exampleSentences: [
  ...
  word('applicable', '적용 가능한', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['appliance', 'appease', 'appellate'],
      definitionDistractors: [
        'required by law to be included in all official documents',
        'able to be downloaded and installed on electronic devices',
        'describing a theory that has been proven through experiments'
      ],
      exampleSentences: [
  ...
  word('appoint', '임명하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['anoint', 'apportion', 'applaud'],
      definitionDistractors: [
        'to schedule a meeting or event at a specific date and time',
        'to promote an employee to a higher salary grade',
        'to evaluate candidates through a formal interview process'
      ],
      exampleSentences: [
  ...
  word('appreciate', '감사하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['apprehend', 'approximate', 'apprentice'],
      definitionDistractors: [
        'to increase in monetary value over a period of time',
        'to formally evaluate the quality of a work of art',
        'to express polite agreement during a social conversation'
      ],
      exampleSentences: [
  ...
  word('appropriate', '적절한', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['apportion', 'approach', 'approve'],
      definitionDistractors: [
        'belonging exclusively to a specific individual or organization',
        'designed to be used only in formal or ceremonial contexts',
        'meeting the minimum legal requirements for public safety'
      ],
      exampleSentences: [
  ...
  word('approximate', '대략적인', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['appropriate', 'apprentice', 'apprehend'],
      definitionDistractors: [
        'measured with scientific instruments to ensure complete accuracy',
        'calculated using a complex mathematical formula',
        'representing the average of multiple precise measurements'
      ],
      exampleSentences: [
  ...
  word('arbitrary', '임의의', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['arbitrate', 'arboretum', 'archive'],
      definitionDistractors: [
        'following a strict set of predetermined rules or guidelines',
        'based on the consensus opinion of a qualified committee',
        'determined by analyzing historical data and statistical trends'
      ],
      exampleSentences: [
  ...
  word('aspect', '측면', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['ascent', 'aspen', 'aspire'],
      definitionDistractors: [
        'the overall appearance or visual impression of an object',
        'the direction that a building or structure faces',
        'a personal opinion formed about a controversial topic'
      ],
      exampleSentences: [
  ...
  word('assemble', '조립하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['resemble', 'ensemble', 'assent'],
      definitionDistractors: [
        'to carefully inspect each component for quality defects',
        'to create a detailed blueprint or design plan',
        'to transport materials from a warehouse to a worksite'
      ],
      exampleSentences: [
  ...
  word('assert', '주장하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['assent', 'avert', 'ascend'],
      definitionDistractors: [
        'to quietly agree with someone without voicing an opinion',
        'to organize information into a logical sequence',
        'to physically insert an object into a designated slot'
      ],
      exampleSentences: [
  ...
  word('assess', '평가하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['access', 'asset', 'assent'],
      definitionDistractors: [
        'to impose a financial penalty for a regulatory violation',
        'to collect data through surveys and questionnaires',
        'to compare two competing products for consumer preference'
      ],
      exampleSentences: [
  ...
  word('assign', '배정하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['assail', 'assort', 'assume'],
      definitionDistractors: [
        'to verify that a task has been completed according to standards',
        'to permanently transfer ownership rights to a third party',
        'to create a written agreement between two contracting parties'
      ],
      exampleSentences: [
  ...
  word('assist', '돕다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['insist', 'persist', 'consist'],
      definitionDistractors: [
        'to supervise a team of workers during a construction project',
        'to provide detailed written instructions for a procedure',
        'to take full responsibility for managing an entire operation'
      ],
      exampleSentences: [
  ...
  word('assume', '가정하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['assure', 'consume', 'resume'],
      definitionDistractors: [
        'to take on a new role or position within an organization',
        'to gather evidence in support of a specific theory',
        'to deliberately mislead someone by providing false information'
      ],
      exampleSentences: [
  ...
  word('attitude', '태도', 5, 'noun',
    ...
    }),
    {
      ...
      definitionDistractors: [
        'the physical posture or stance of a person while standing',
        'a specific skill or talent developed through practice',
        'the level of confidence someone shows during public speaking'
      ],
      exampleSentences: [
  ...
  word('attribute', '~에 귀속시키다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['contribute', 'distribute', 'attrition'],
      definitionDistractors: [
        'a distinguishing quality or characteristic of a person or thing',
        'to add supplementary information to an existing report',
  ...
  word('authority', '권한', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['auditory', 'austerity', 'autonomy'],
      definitionDistractors: [
        'a person who is considered an expert in a particular field',
        'a written document granting permission for a specific activity',
        'the process of verifying someone\'s identity or credentials'
      ],
      exampleSentences: [
  ...
  word('automatic', '자동의', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['autonomic', 'autocratic', 'authentic'],
      definitionDistractors: [
        'powered by electricity rather than fossil fuels',
        'programmed to follow a specific sequence of commands',
        'designed to be easily operated by untrained users'
      ],
      exampleSentences: [
  ...
  word('barely', '겨우', 5, 'adverb',
    ...
    }),
    {
      ...
      wordDistractors: ['barley', 'bargain', 'baron'],
      definitionDistractors: [
        'in a completely exposed or uncovered manner',
        'with great reluctance or unwillingness to participate',
        'at a significantly reduced price or discount'
      ],
      exampleSentences: [
  ...
  word('barrier', '장벽', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['barrister', 'barter', 'barrel'],
      definitionDistractors: [
        'a person who manages the entry gate at a public venue',
        'a legal agreement that restricts trade between countries',
        'a protective covering used to shield equipment from damage'
      ],
      exampleSentences: [
  ...
  word('behalf', '~을 위해', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['behave', 'behold', 'believe'],
      definitionDistractors: [
        'the act of dividing something equally among all participants',
        'a personal statement of opinion presented during a debate',
        'a formal written request submitted to a government agency'
      ],
      exampleSentences: [
  ...
  word('bewildered', '당황한', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['bewitched', 'beleaguered', 'beloved'],
      definitionDistractors: [
        'feeling deeply saddened by a tragic loss or event',
        'being physically exhausted after prolonged physical activity',
        'feeling extremely angry about an unfair treatment'
      ],
      exampleSentences: [
  ...
  word('bias', '편견', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['basis', 'bison', 'basin'],
      definitionDistractors: [
        'a formal accusation made against someone in a legal proceeding',
        'a systematic method for organizing information by category',
        'a natural tendency to prefer one hand over the other'
      ],
      exampleSentences: [
  ...
  word('bond', '유대', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['blond', 'boned', 'bound'],
      definitionDistractors: [
        'a financial certificate that pays interest over a fixed period',
        'a type of adhesive material used in construction projects',
        'a formal contract between an employer and an employee'
      ],
      exampleSentences: [
  ...
  word('boundary', '경계', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['bounty', 'foundry', 'laundry'],
      definitionDistractors: [
        'a reward offered for the completion of a difficult task',
        'the total area enclosed within a geographic region',
        'a measurement of the distance between two fixed points'
      ],
      exampleSentences: [
  ...
  word('broad', '넓은', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['brood', 'broach', 'abroad'],
      definitionDistractors: [
        'having a strong and durable physical structure',
        'occurring over a very long period of time',
        'being clearly visible from a great distance'
      ],
      exampleSentences: [
  ...
  word('budget', '예산', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['bucket', 'budge', 'buffet'],
      definitionDistractors: [
        'the total revenue generated by a business in one fiscal year',
        'a tax imposed on imported goods by the government',
        'a savings account used exclusively for emergency expenses'
      ],
      exampleSentences: [
  ...
  word('burden', '부담', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['burnish', 'burrow', 'bourbon'],
      definitionDistractors: [
        'a large quantity of goods transported by ship or truck',
        'a formal obligation outlined in a legal contract',
        'a natural resource extracted from underground deposits'
      ],
      exampleSentences: [
  ...
  word('bureaucracy', '관료제', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['burglary', 'buoyancy', 'burgundy'],
      definitionDistractors: [
        'a democratic system where citizens vote directly on all laws',
        'a private organization that operates without government oversight',
        'a method of streamlining business operations for maximum profit'
      ],
      exampleSentences: [
  ...
  word('capable', '유능한', 5, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['capital', 'captain', 'capsule'],
      definitionDistractors: [
        'willing to take risks in order to achieve ambitious goals',
        'having received formal training in a specialized discipline',
        'being legally authorized to perform a specific professional duty'
      ],
      exampleSentences: [
  ...
  word('capacity', '수용량', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['captive', 'capitol', 'caption'],
      definitionDistractors: [
        'the rate at which a machine produces output per hour',
        'the total number of employees working in a company',
        'the electrical charge stored in a battery or power cell'
      ],
      exampleSentences: [
  ...
  word('capture', '포착하다', 5, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['caption', 'capsule', 'caprice'],
      definitionDistractors: [
        'to create a digital copy of a document or image',
        'to attract and hold someone\'s attention through entertainment',
        'to enclose an area with a fence or physical structure'
      ],
      exampleSentences: [
  ...
  word('category', '범주', 5, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['caterer', 'catalog', 'cathedral'],
      definitionDistractors: [
        'a ranking system that orders items from best to worst',
        'a collection of items stored together in a single container',
        'a label attached to a product indicating its price and origin'
      ],
      exampleSentences: [
