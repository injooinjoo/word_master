...
export const vocabBatch66: VocabItem[] = [
  ...
  word('total', '합계, 전체', 5, 'noun',
    ['부분', '일부', '조각', '단편', '절반', '파편', '분할', '나머지', '잔여', '소수'],
    tips({
      ...
      context: '주로 비용, 점수, 인원 등을 모두 합산한 최종 수치를 나타낼 때 사용합니다.',
      synonymAntonym: '전체 양을 뜻하는 sum과 유사하며, 부분을 뜻하는 part와 반대됩니다.',
    }),
    {
      definition: 'the entire amount or number of something when all parts are added together',
      synonyms: ['sum', 'aggregate', 'whole'],
  ...
  word('toy', '장난감', 3, 'noun',
    ['교과서', '약품', '도구', '무기', '기계', '장비', '가전제품', '의료기기', '서류', '사무용품'],
    tips({
      etymology: '중세 영어에서 유래한 단어로, 아이들이 가지고 노는 물건을 의미합니다.',
      visual: '아이 방 바닥에 알록달록한 블록, 인형, 자동차 모형이 흩어져 있는 모습을 상상해 보세요.',
      soundAlike: '한국어에서도 \'토이\'라는 말을 그대로 사용하여 익숙한 발음입니다.',
      context: '어린이가 가지고 노는 물건뿐만 아니라 어른들의 취미용 모형이나 전자 기기에도 쓰입니다.',
      synonymAntonym: '놀이를 위한 plaything과 유사하며, 실용적인 도구인 tool과는 대조됩니다.',
    }),
    {
      definition: 'an object for a child to play with, typically a model or miniature replica of something',
      synonyms: ['plaything', 'game', 'doll'],
      antonyms: ['tool', 'equipment', 'necessity'],
      exampleSentences: [
  ...
  word('transfer', '옮기다', 6, 'verb',
    ['고정하다', '유지하다', '보존하다', '머무르다', '정지하다', '고수하다', '잔류하다', '방치하다', '보관하다', '거부하다'],
    tips({
      ...
      synonymAntonym: '이동시키는 relocate와 유사하며, 한곳에 머무르게 하는 retain과 반대됩니다.',
    }),
    {
      definition: 'to move someone or something from one place, position, or group to another',
      synonyms: ['relocate', 'move', 'shift'],
  ...
  word('transform', '변형시키다', 7, 'verb',
    ['유지하다', '보존하다', '고정하다', '머무르다', '정체시키다', '방치하다', '되돌리다', '고수하다', '반복하다', '답습하다'],
    tips({
      ...
      context: '외모, 성격, 시스템 등 무엇이든 근본적으로 바꿀 때 사용되는 강력한 동사입니다.',
      synonymAntonym: 'convert, change와 유사하며, 현 상태를 유지하는 preserve와 반대됩니다.',
    }),
    {
      definition: 'to change something completely in form, appearance, or nature',
  ...
  word('true', '사실인, 진실된', 2, 'adjective',
    ...
    {
      definition: 'in accordance with fact or reality; not false or made up',
      synonyms: ['genuine', 'authentic', 'real'],
      antonyms: ['false', 'fake', 'untrue'],
      exampleSentences: [
