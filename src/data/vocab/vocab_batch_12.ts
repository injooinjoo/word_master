...
export const vocabBatch12: VocabItem[] = [
  ...
  word('Equivalent', '동등한', 6, 'adjective',
    ['불균형', '비대칭', '열등', '우위', '차이', '불일치', '상이', '비등가', '좋은', '화난'],
    tips({
  ...
  word('Erode', '침식하다', 6, 'verb',
    ['축적하다', '쌓다', '건설하다', '보강하다', '보존하다', '축적', '강화', '건설', '증가', '먹다'],
    tips({
  ...
  word('Exaggerate', '과장하다', 6, 'verb',
    ['축소하다', '축약하다', '최소화하다', '왜소화하다', '축소', '먹다', '뛰다', '사랑하다', '열다', '춤추다'],
    tips({
  ...
  word('Exploit', '이용하다', 6, 'verb',
    ['보호하다', '돌보다', '지키다', '방어하다', '수호', '보존', '보호', '옹호', '비호', '먹다'],
    tips({
  ...
  word('Extract', '추출하다', 6, 'verb',
    ['주입하다', '삽입하다', '혼합하다', '적하하다', '주입', '삽입', '혼합', '융합', '적하', '먹다'],
    tips({
  ...
  word('Feasible', '실행 가능한', 6, 'adjective',
    ['불가능한', '비현실적', '실현불가', '불가', '무리', '비실용', '불가능', '비가능', '환상적', '좋은'],
    tips({
  ...
  word('Fierce', '사나운', 6, 'adjective',
    ['온순한', '순한', '부드러운', '완화된', '평화적', '우호적', '온화', '유순', '온순', '좋은'],
    tips({
  ...
  word('Fiscal', '재정의', 6, 'adjective',
    ['비재정', '비경제', '군사적', '사회적', '문화적', '감정적', '도덕적', '법적', '좋은', '화난'],
    tips({
  ...
  word('Fluctuate', '변동하다', 6, 'verb',
    ['안정되다', '고정되다', '일정하다', '불변', '정체', '고착', '안정', '고정', '일정', '먹다'],
    tips({
  ...
  word('Fraction', '분수', 6, 'noun',
    ['전체', '전량', '합계', '전부', '통째', '100%', '완전', '사과', '책', '고양이'],
    tips({
  ...
  word('Framework', '틀', 6, 'noun',
    ['무질서', '혼란', '무구조', '분산', '해체', '비체계', '산발', '무계획', '혼재', '사과'],
    tips({
  ...
  word('Franchise', '가맹점', 6, 'noun',
    ['독립점', '자영점', '직영', '본점', '비가맹', '독립', '자영', '단독', '본사', '사과'],
    tips({
  ...
  word('Friction', '마찰', 6, 'noun',
    ['윤활', '부드러움', '조화', '협력', '화합', '원활', '유동', '평화', '사과', '책'],
    tips({
  ...
  word('Frontier', '국경', 6, 'noun',
    ['내부', '수도', '안쪽', '중앙', '내륙', '핵심', '본토', '내지', '심장부', '사과'],
    tips({
  ...
  word('Generous', '관대한', 6, 'adjective',
    ['인색한', '아까워하는', '짠', '보수적', '검소', '인색', '조숙', '짜릿', '검약', '좋은'],
    tips({
