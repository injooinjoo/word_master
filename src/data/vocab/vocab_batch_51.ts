...
export const vocabBatch51: VocabItem[] = [
  ...
  word('play', '놀다', 1, 'noun',
    ...
    tips({
      ...
      visual: '무대 위에서 화려한 의상을 입고 연기하는 배우들의 모습을 상상해 보세요.',
      soundAlike: '악기를 \'플레이\'한다고 할 때의 그 발음을 떠올리면 쉽습니다.',
      context: '명사로 쓰일 때는 아이들의 놀이뿐만 아니라 연극이나 희곡을 의미하기도 합니다.',
      synonymAntonym: 'drama나 show와는 비슷하지만, work나 reality와는 반대되는 개념입니다.',
    }),
    {
      definition: 'A dramatic work intended for performance by actors on a stage or a broadcast.',
      synonyms: ['drama', 'production', 'performance'],
      antonyms: ['work', 'reality', 'labor'],
      exampleSentences: [
        { en: 'The local theater group is performing a famous Shakespearean drama this weekend.', ko: '지역 극단이 이번 주말에 유명한 셰익스피어 연극을 공연합니다.' },
        { en: 'Tickets for the new Broadway show sold out within minutes of going on sale.', ko: '새로운 브로드웨이 연극 티켓이 판매 시작 몇 분 만에 매진되었습니다.' },
      ],
    }
  ),
  ...
  word('pole', '폴란드사람', 4, 'noun',
    ...
    tips({
      ...
      visual: '폴란드의 하얀색과 빨간색 국기를 흔들고 있는 사람의 모습을 상상해 보세요.',
      soundAlike: '막대기를 뜻하는 \'pole\'과 발음이 같으므로, 막대기를 든 폴란드인을 떠올리면 쉽습니다.',
      context: '국적이나 출신 성분을 나타낼 때 사용하며, 대문자 P로 시작하는 경우가 많습니다.',
      synonymAntonym: '폴란드 시민을 뜻하는 Polish citizen과 유사하며, 타국인과는 대조됩니다.',
    }),
    {
      definition: 'A native or inhabitant of Poland, or a person of Polish descent.',
      synonyms: ['Polish person', 'Polish citizen', 'native of Poland'],
      antonyms: ['foreigner', 'alien', 'non-resident'],
      exampleSentences: [
        { en: 'The famous composer Frederic Chopin was a proud native born as a Pole.', ko: '유명한 작곡가 프레데리크 쇼팽은 폴란드인으로 태어난 자랑스러운 원주민이었습니다.' },
        { en: 'Every Pole I met during my trip to Warsaw was incredibly welcoming and kind.', ko: '바르샤바 여행 중에 만난 모든 폴란드 사람들은 믿을 수 없을 정도로 환대해주고 친절했습니다.' },
      ],
    }
  ),
  word('police', '경비하다', 3, 'verb',
    ...
    tips({
      ...
      visual: '제복을 입은 보안 요원이 구역을 순찰하며 출입을 통제하는 모습을 상상해 보세요.',
      soundAlike: '\'폴리스\' 발음이 \'풀리스(풀어주지 않다)\'와 비슷하다고 생각하며 질서를 꽉 잡고 감시하는 이미지를 연결하세요.',
      context: '명사로는 경찰관을 뜻하지만, 동사로는 특정 지역의 질서를 유지하거나 규정을 준수하는지 감시할 때 쓰입니다.',
      synonymAntonym: '질서를 지키는 monitor와 방치하는 neglect를 대조하여 기억하면 효과적입니다.',
    }),
    {
      definition: 'to control or monitor an area or activity to ensure that laws or rules are being obeyed',
      synonyms: ['monitor', 'patrol', 'supervise'],
      antonyms: ['neglect', 'ignore', 'abandon'],
      exampleSentences: [
        { en: 'The organizers hired extra security staff to help control and monitor the festival grounds.', ko: '주최 측은 축제 현장을 경비하고 감시하는 것을 돕기 위해 추가 보안 요원을 고용했습니다.' },
        { en: 'It is difficult for the government to effectively regulate and oversee every corner of the internet.', ko: '정부가 인터넷의 모든 구석을 효과적으로 치안 유지하고 규제하는 것은 어렵습니다.' },
      ],
    }
  ),
  ...
  word('polish', '닦다', 8, 'noun',
    ...
    tips({
      ...
      context: '가구, 신발, 금속 제품의 표면을 매끄럽고 윤기 나게 만드는 물질이나 그 상태를 의미합니다.',
      synonymAntonym: '광택을 내는 gloss와 반대로, 빛을 흡수하여 광이 없는 상태는 matte라고 합니다.',
    }),
    {
      definition: 'A substance used to make a surface smooth and shiny by rubbing it.',
      synonyms: ['varnish', 'glaze', 'sheen'],
      antonyms: ['dullness', 'roughness', 'tarnish'],
      exampleSentences: [
        { en: 'She applied a thick layer of silver polish to the antique spoons.', ko: '그녀는 골동품 숟가락에 은 광택제를 두껍게 발랐다.' },
        { en: 'The wooden floor lost its bright polish after years of heavy use.', ko: '나무 바닥은 수년간의 심한 사용 끝에 그 밝은 윤기를 잃었다.' },
      ],
    }
  ),
