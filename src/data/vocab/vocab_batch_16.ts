...
export const vocabBatch16: VocabItem[] = [
  ...
  word('Euphemism', '완곡어', 8, 'noun',
    ['직설', '노골적 표현', '비속어', '욕설', '적나라함', '노골', '비속', '적나라', '직언', '사과'],
    tips({
  ...
  word('Frugal', '검소한', 8, 'adjective',
    ['낭비하는', '사치스러운', '마구 쓰는', '낭비적', '호화로운', '낭비', '사치', '마구쓰기', '호화', '좋은'],
    tips({
  ...
  word('Grievance', '불만', 8, 'noun',
    ['만족', '감사', '만족감', '기쁨', '승인', '사과', '책', '고양이', '개', '물고기'],
    tips({
  ...
  word('Harbinger', '전조', 8, 'noun',
    ['후과', '결과', '여파', '끝맺음', '최종', '사과', '책', '고양이', '개', '물고기'],
    tips({
  ...
  word('Hierarchy', '위계', 8, 'noun',
    ['평등', '수평', '동등', '혼돈', '무질서', '사과', '책', '고양이', '개', '물고기'],
    tips({
  ...
  word('Hubris', '오만', 8, 'noun',
    ['겸손', '겸양', '자기비하', '겸허', '겸손함', '사과', '책', '고양이', '개', '물고기'],
    tips({
  ...
  word('Idiosyncrasy', '성벽', 8, 'noun',
    ['범례', '보편성', '일반성', '표준', '정상', '보편', '일반', '사과', '책', '고양이'],
    tips({
  ...
  word('Imminent', '임박한', 8, 'adjective',
    ['먼', '먼 훗날의', '불확실한', '연기된', '늦춰진', '불확실', '연기', '늦춤', '원거리', '좋은'],
    tips({
