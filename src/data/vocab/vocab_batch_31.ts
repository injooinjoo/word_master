...
export const vocabBatch31: VocabItem[] = [
  ...
  word('dictate', '받아쓰게 하다', 9, 'verb',
    ['앞으로 나아가다', '대피시키다', '(자금, 물건 등을) 책정하다', '처벌하다', '떠나다, 비우다', '속이다', '(모양,구조, 특징) 바꾸다', '힘들게 일하다, 수고하다', '금지하다', '분리하다, 절단하다'],
    tips({
  ...
  word('dine', '식사하다', 5, 'verb',
    ['분석하다', '정리하다', '휘젓다', '혼합하다', '애타게 하다', '등록하다', '철저히 수색하다, 조사하다', '완화하다, 경감시키다', '중재하다', '1, 고안하다, 발전시키다\n2. 명확히 말하다'],
    tips({
  ...
  word('distract', '산만하게 하다', 7, 'verb',
    ['집중하다', '무시하다', '애지중지하다 / 응석받이로 키우다', '보충하다', '방출하다', '활성화하다', '강제하다', '감소시키다', '수호하다, 지지하다', '성질을 바꾸다, 변형하다'],
    tips({
  ...
  word('disturb', '방해하다', 5, 'verb',
    ['(솔과 물로) 북북 문질러 닦다 / 샅샅이 뒤지다', '유포하다', '확인하다, 단언하다', '가르치다', '방해하다', '꿰뚫다', '(죄, 과실) 경감시키다, 가볍게 하다', '선택하다', '결정하다', '요청하다'],
    tips({
  ...
  word('do', '하다', 1, 'verb',
    ['결정하다', '요청하다', '설명하다', '관리하다', '보완하다', '분석하다', '정리하다', '꾸짖다, 나무라다', '잡다', '강화하다, 심화하다'],
    tips({
