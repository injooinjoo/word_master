...
export const vocabBatch14: VocabItem[] = [
  ...
  word('Commensurate', '비례하는', 7, 'adjective',
    ['불균형한', '과다한', '부족한', '어긋난', '불일치', '부적절', '과대', '과소', '불균형', '불균형'],
    tips({
  ...
  word('Complement', '보완하다', 7, 'verb',
    ['훼손하다', '상쇄하다', '해치다', '불일치', '충돌', '상쇄', '해체', '파괴', '불화합', '불일치'],
    tips({
  ...
  word('Confluence', '합류점', 7, 'noun',
    ['분기점', '갈림길', '분산', '이탈', '분리', '분기', '갈래', '분산', '해체', '분할'],
    tips({
  ...
  word('Credible', '믿을 만한', 7, 'adjective',
    ['의심스러운', '믿기 어려운', '불신할 만한', '허황된', '거짓', '부정', '불신', '허위', '의심', '불신'],
    tips({
