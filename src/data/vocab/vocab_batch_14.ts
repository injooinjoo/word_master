...
export const vocabBatch14: VocabItem[] = [
  word('benevolent', '자비로운', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Belligerent', 'Prevalent', 'Malevolent'],
      definitionDistractors: [
        'Aggressive and eager to start a conflict or argument.',
        'Widely accepted or commonly occurring across a region.',
        'Having a strong influence that spreads rapidly through a group.',
      ],
    }
  ),
  word('blatant', '노골적인', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Blatent', 'Latent', 'Bivalent'],
      definitionDistractors: [
        'Hidden beneath the surface and not yet fully developed.',
        'Expressed cautiously and with great diplomatic sensitivity.',
        'Having two opposing values or qualities at the same time.',
      ],
    }
  ),
  word('bolster', '강화하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Holster', 'Bluster', 'Bolter'],
      definitionDistractors: [
        'To carry or store something in a protective case.',
        'To speak in a loud and aggressive manner without substance.',
        'To move suddenly and quickly in an unexpected direction.',
      ],
    }
  ),
  word('brevity', '간결함', 7, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['Bravery', 'Gravity', 'Levity'],
      definitionDistractors: [
        'The courage to face danger or difficulty without fear.',
        'The seriousness and importance of a situation or matter.',
        'The feeling of lightness and humor in a tense moment.',
      ],
    }
  ),
  word('candid', '솔직한', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Candied', 'Candidate', 'Canned'],
      definitionDistractors: [
        'Coated with a sweet glaze or sugar-based coating.',
        'A person who is being considered for a specific role or position.',
        'Preserved in a sealed container for long-term storage.',
      ],
    }
  ),
  word('catalyst', '촉매', 7, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['Cataract', 'Catapult', 'Catalogue'],
      definitionDistractors: [
        'A large waterfall or a medical condition clouding the eye lens.',
        'A device used to launch objects over a great distance.',
        'A comprehensive list or inventory of items in a collection.',
      ],
    }
  ),
  word('caustic', '부식성의', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Causal', 'Cautious', 'Cosmic'],
      definitionDistractors: [
        'Relating to or acting as the direct reason for an event.',
        'Careful to avoid potential problems or dangers.',
        'Relating to the universe or its vast, infinite nature.',
      ],
    }
  ),
  word('cede', '양도하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Seed', 'Ceded', 'Cease'],
      definitionDistractors: [
        'To plant or distribute seeds for agricultural growth.',
        'To come to a complete stop or bring an activity to an end.',
        'To officially approve or endorse a formal agreement.',
      ],
    }
  ),
  word('censure', '비난하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Censor', 'Census', 'Censer'],
      definitionDistractors: [
        'To examine and remove content deemed offensive or inappropriate.',
        'An official count of the population in a given area.',
  ...
  word('circumscribe', '제한하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Circumvent', 'Circumspect', 'Subscribe'],
      definitionDistractors: [
        'To find a way around an obstacle or to cleverly avoid a rule.',
        'Cautious and attentive to all possible consequences before acting.',
        'To arrange to receive a publication or service on a regular basis.',
      ],
    }
  ),
  word('coerce', '강요하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Coarse', 'Cohere', 'Commerce'],
      definitionDistractors: [
        'Having a rough or uneven texture on the surface.',
        'To stick together firmly as a unified whole.',
  ...
  word('cogent', '설득력 있는', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Cognate', 'Regent', 'Urgent'],
      definitionDistractors: [
        'Related by descent from the same ancestral language or root.',
        'A person appointed to govern in the absence of a monarch.',
        'Requiring immediate action or attention without delay.',
      ],
    }
  ),
  word('coherent', '일관된', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Cohesive', 'Inherent', 'Adherent'],
      definitionDistractors: [
        'Tending to stick together or form a unified mass.',
        'Existing as a permanent and inseparable quality of something.',
        'A person who supports a particular party, leader, or set of ideas.',
      ],
    }
  ),
  word('commensurate', '비례하는', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Commemorate', 'Commiserate', 'Commencement'],
      definitionDistractors: [
        'To honor or celebrate the memory of a past event or person.',
        'To express sympathy or pity for someone in their suffering.',
        'The beginning or start of something, especially a ceremony.',
      ],
    }
  ),
  word('compendium', '요약집', 7, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['Compendious', 'Addendum', 'Referendum'],
      definitionDistractors: [
        'An additional item attached to the end of a document or book.',
        'A general vote by the electorate on a single political question.',
        'A detailed and exhaustive study covering every aspect of a topic.',
      ],
    }
  ),
  word('complacent', '안주하는', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Complaisant', 'Compliant', 'Competent'],
      definitionDistractors: [
        'Willing to please others by being agreeable and obliging.',
        'Acting in accordance with rules, standards, or requests.',
        'Having the necessary ability or skill to do something effectively.',
      ],
    }
  ),
  word('complement', '보완하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Compliment', 'Implement', 'Supplement'],
      definitionDistractors: [
        'To express praise or admiration for someone or something.',
        'To put a plan or decision into effect and carry it out.',
        'To add an extra element to make up for a deficiency.',
      ],
    }
  ),
  word('comply', '준수하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Complain', 'Imply', 'Apply'],
      definitionDistractors: [
        'To express dissatisfaction or annoyance about a situation.',
        'To suggest something indirectly without stating it openly.',
        'To make a formal request for a job, position, or opportunity.',
      ],
    }
  ),
  word('concede', '인정하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Conceal', 'Conceive', 'Conceit'],
      definitionDistractors: [
        'To keep something hidden from view or knowledge.',
        'To form an idea or plan in the mind for the first time.',
  ...
  word('conciliatory', '화해적인', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Conciliate', 'Oscillatory', 'Consolatory'],
      definitionDistractors: [
        'Moving back and forth in a regular rhythmic pattern.',
        'Providing comfort to someone experiencing grief or disappointment.',
        'Serving to officially confirm or verify an established fact.',
      ],
    }
  ),
  word('concurrent', '동시의', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Concurring', 'Recurrent', 'Current'],
      definitionDistractors: [
        'Happening again and again at irregular intervals.',
        'Belonging to the present time or moment in progress.',
  ...
  word('condone', '묵인하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Condole', 'Condemn', 'Conduit'],
      definitionDistractors: [
        'To express sympathy with someone who is grieving or suffering.',
        'To express strong disapproval and declare something unacceptable.',
  ...
  word('confluence', '합류점', 7, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['Affluence', 'Influence', 'Effluence'],
      definitionDistractors: [
        'The state of having a great deal of wealth and material resources.',
        'The capacity to have an effect on the character or behavior of someone.',
        'The flowing out of a substance, especially waste or sewage.',
      ],
    }
  ),
  word('conjecture', '추측', 7, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['Conjunction', 'Conjure', 'Lecture'],
      definitionDistractors: [
        'A word used to connect clauses or sentences together.',
        'To make something appear unexpectedly as if by magic.',
        'An educational talk given to an audience on a particular subject.',
      ],
    }
  ),
  word('connive', '공모하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Contrive', 'Connote', 'Convive'],
      definitionDistractors: [
        'To plan with ingenuity or bring about through clever methods.',
        'To imply or suggest an additional meaning beyond the literal one.',
        'To live together or share a communal social environment.',
      ],
    }
  ),
  word('consecutive', '연속적인', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Conservative', 'Collective', 'Executive'],
      definitionDistractors: [
        'Holding to traditional attitudes and cautious about change.',
        'Done by or belonging to all members of a group together.',
  ...
  word('conspicuous', '눈에 띄는', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Auspicious', 'Suspicious', 'Perspicuous'],
      definitionDistractors: [
        'Indicating favorable conditions and a good chance of success.',
        'Having or showing a cautious distrust of someone or something.',
        'Expressed clearly enough to be easily understood by others.',
      ],
    }
  ),
  word('convoluted', '복잡한', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Convolute', 'Involuted', 'Devoted'],
      definitionDistractors: [
        'Rolled up or coiled into a spiral or cylindrical shape.',
        'Deeply committed and dedicated to a cause or person.',
        'Gradually changed over time into a different and better form.',
      ],
    }
  ),
  word('constrain', '제한하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Constrict', 'Restrain', 'Sustain'],
      definitionDistractors: [
        'To make something narrower by squeezing or tightening around it.',
        'To prevent someone from doing something by physical control.',
        'To maintain or keep something going over a long period of time.',
      ],
    }
  ),
  word('contend', '다투다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Content', 'Contempt', 'Contort'],
      definitionDistractors: [
        'Feeling satisfied and at ease with one\'s current situation.',
        'The feeling that someone or something is worthless or despicable.',
        'To twist or bend something out of its normal shape violently.',
      ],
    }
  ),
  word('contention', '논쟁', 7, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['Attention', 'Retention', 'Detention'],
      definitionDistractors: [
        'The act of focusing one\'s mind closely on a subject or activity.',
        'The continued possession or keeping of something in memory.',
        'The act of holding someone in official custody or confinement.',
      ],
    }
  ),
  word('contingent', '조건부의', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Contiguous', 'Contingency', 'Stringent'],
      definitionDistractors: [
        'Sharing a common border or being next to each other in space.',
        'A possible future event that could cause problems if it occurs.',
        'Strictly enforced with no room for deviation or exception.',
      ],
    }
  ),
  word('contrive', '꾀하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Connive', 'Contrite', 'Contrived'],
      definitionDistractors: [
        'To secretly cooperate with others in an unethical scheme.',
        'Feeling deep remorse and regret for a wrongdoing.',
        'Lacking in natural or spontaneous quality; overly artificial.',
      ],
    }
  ),
  word('converge', '수렴하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Converse', 'Diverge', 'Submerge'],
      definitionDistractors: [
        'To engage in an informal spoken exchange of thoughts.',
  ...
  word('convict', '유죄 판결하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Convince', 'Conflict', 'Constrict'],
      definitionDistractors: [
        'To persuade someone to believe or do something through reasoning.',
        'A serious disagreement or argument between opposing parties.',
        'To squeeze or tighten something so it becomes narrower.',
      ],
    }
  ),
  word('copious', '풍부한', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Captious', 'Capricious', 'Conscious'],
      definitionDistractors: [
        'Tending to find fault or raise petty objections unnecessarily.',
        'Given to sudden and unpredictable changes in mood or behavior.',
        'Being awake and aware of one\'s surroundings and existence.',
      ],
    }
  ),
  word('cordial', '따뜻한', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Cardinal', 'Chordal', 'Morbid'],
      definitionDistractors: [
        'Of the greatest importance; fundamental or primary.',
        'Relating to the structural harmony of musical notes or chords.',
  ...
  word('corrode', '부식시키다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Correct', 'Erode', 'Correlate'],
      definitionDistractors: [
        'To officially fix or set right an error in a document.',
        'To gradually wear away the surface of land by natural forces.',
        'To bring together different elements into a unified arrangement.',
      ],
    }
  ),
  word('corroborate', '입증하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Collaborate', 'Elaborate', 'Exonerate'],
      definitionDistractors: [
        'To work jointly with others on a shared project or activity.',
        'To develop or present a theory in further detail.',
  ...
  word('covert', '비밀의', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Overt', 'Convert', 'Covet'],
      definitionDistractors: [
        'Done or shown openly without any attempt at concealment.',
        'To change the form, character, or function of something.',
        'To yearn to possess something that belongs to someone else.',
      ],
    }
  ),
  word('credible', '믿을 만한', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Credulous', 'Incredible', 'Edible'],
      definitionDistractors: [
        'Too willing to believe things without sufficient evidence.',
        'Impossible to believe or extraordinarily impressive.',
        'Safe and suitable for consumption as food.',
      ],
    }
  ),
  word('culminate', '절정에 달하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Cumulate', 'Ruminate', 'Illuminate'],
      definitionDistractors: [
        'To gather or pile up gradually over a period of time.',
        'To think deeply and carefully about something at length.',
        'To light up or brighten a space with a source of light.',
      ],
    }
  ),
  word('curtail', '축소하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Curtain', 'Detail', 'Retail'],
      definitionDistractors: [
        'A piece of fabric hung to cover a window or divide a room.',
        'An individual feature or item considered separately from the whole.',
        'The sale of goods to the public in small quantities for consumption.',
      ],
    }
  ),
  word('cynical', '냉소적인', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Clinical', 'Cyclical', 'Lyrical'],
      definitionDistractors: [
        'Relating to the observation and treatment of patients in a medical setting.',
        'Occurring in cycles or repeating in a regular pattern over time.',
        'Expressing deep personal emotions in a beautiful and imaginative way.',
      ],
    }
  ),
  word('daunting', '벅찬', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Haunting', 'Flaunting', 'Taunting'],
      definitionDistractors: [
        'Remaining in the mind and difficult to forget or ignore.',
        'Displaying something ostentatiously to provoke admiration or envy.',
        'Provoking or mocking someone with insulting remarks or gestures.',
      ],
    }
  ),
  word('debilitate', '약화시키다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Deliberate', 'Rehabilitate', 'Facilitate'],
      definitionDistractors: [
        ...
        'To make an action or process easier and more efficient.',
      ],
    }
  ),
  word('decadent', '퇴폐적인', 7, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['Decent', 'Decadence', 'Precedent'],
      definitionDistractors: [
        'Meeting accepted standards of behavior or quality.',
        'A period of ten years used as a historical measurement.',
        'An earlier event or action that serves as a guide for the future.',
      ],
    }
  ),
  word('decipher', '해독하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Decimate', 'Disciple', 'Decimal'],
      definitionDistractors: [
        'To destroy a large proportion of something completely.',
        'A personal follower who accepts the teachings of a leader.',
  ...
  word('decree', '포고령', 7, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['Degree', 'Discreet', 'Decry'],
      definitionDistractors: [
        'A unit of measurement for temperature or angles.',
        'Careful and prudent in conduct to avoid causing offense.',
  ...
  word('deem', '간주하다', 7, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['Dream', 'Demean', 'Redeem'],
      definitionDistractors: [
        'A series of images and sensations occurring in one\'s mind during sleep.',
        'To cause a loss of dignity or respect for someone.',
