...
export const vocabBatch43: VocabItem[] = [
  ...
  word('lift', '끌어올리다', 7, 'verb',
    ...
    {
      definition: 'the act of raising something to a higher position or level',
      synonyms: ['elevation', 'ascent', 'boost'],
      antonyms: ['descent', 'drop', 'fall'],
      exampleSentences: [
  ...
  word('link', '연결, 고리', 4, 'noun',
    ...
    {
      definition: 'Relating to or consisting of a series of connected metal rings or joined elements forming a chain.',
      synonyms: ['connected', 'chained', 'interlocked'],
