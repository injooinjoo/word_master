...
export const vocabBatch18: VocabItem[] = [
  word('corpulent', '비만한', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['corporal', 'opulent', 'truculent'],
      definitionDistractors: [
        'relating to the physical body or material substance',
        'having a calm and composed manner in stressful situations',
        'showing great skill or expertise in a particular field',
      ],
    }
  ),
  word('cosset', '응석받이하다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['corset', 'closet', 'casket'],
      definitionDistractors: [
        'to arrange items neatly in a small enclosed space',
        'to criticize or scold someone harshly for their behavior',
        'to place a tight-fitting garment around the torso for support',
      ],
    }
  ),
  word('cosmopolitan', '세계적인', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['cosmonaut', 'metropolitan', 'constellation'],
      definitionDistractors: [
        'relating to the study of the universe and celestial bodies',
        'belonging exclusively to a single metropolitan area or city',
        'having a strong preference for one cultural tradition over others',
      ],
    }
  ),
  word('counterfeit', '위조품', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['counterpart', 'countersign', 'countermand'],
      definitionDistractors: [
        'an opposite or complementary version of something',
        'a response made in opposition to a previous argument',
        'an official document confirming a transaction or agreement',
      ],
    }
  ),
  word('craven', '비겁한', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['craving', 'cavern', 'raven'],
      definitionDistractors: [
        'having a strong desire or yearning for something',
        'acting in a wild and untamed manner like an animal',
        'deeply engraved or carved into a surface',
      ],
    }
  ),
  word('credulous', '쉽게 믿는', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['credible', 'credence', 'querulous'],
      definitionDistractors: [
        'worthy of being believed or trusted as reliable',
        'expressing doubt and asking many critical questions',
        'having official authority or recognized qualifications',
      ],
    }
  ),
  word('curmudgeon', '심술궂은 사람', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['bludgeon', 'dungeon', 'gudgeon'],
      definitionDistractors: [
        'a person who mediates disputes between opposing parties',
        'a large underground chamber used for storage or shelter',
        'a wise elder who gives sage advice to the community',
      ],
    }
  ),
  word('cursory', '대충의', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['cursive', 'courier', 'cursor'],
      definitionDistractors: [
        'written in flowing, connected script by hand',
        'relating to a blinking indicator on a computer screen',
        'done with extreme precision and careful attention to detail',
      ],
    }
  ),
  word('dearth', '부족', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['death', 'earth', 'hearth'],
      definitionDistractors: [
        'the soil or ground beneath one\'s feet',
        'a sudden and catastrophic natural disaster',
        'an overabundance or excessive supply of resources',
      ],
    }
  ),
  word('debacle', '대참사', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['debatable', 'debonair', 'tentacle'],
      definitionDistractors: [
        'a formal discussion or argument on a specific topic',
        'a gradual and controlled reduction in resources',
        'a minor setback that is easily overcome',
      ],
    }
  ),
  word('decorum', '예의', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['decor', 'decree', 'decorous'],
      definitionDistractors: [
        'the style of interior furnishings and decorative elements in a room',
        'a formal written decree issued by a court of law',
        'the process of removing ornamental features from a building',
      ],
    }
  ),
  word('deleterious', '유해한', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['delirious', 'delectable', 'deliberate'],
      definitionDistractors: [
        'experiencing wild excitement or ecstatic joy',
        'capable of being removed or erased permanently',
        'providing nourishment and promoting healthy growth',
      ],
    }
  ),
  word('demagogue', '선동가', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['demography', 'dialogue', 'pedagogue'],
      definitionDistractors: [
        'a scholar who studies population statistics and trends',
        'a diplomat who negotiates treaties between nations',
        'a teacher who instructs students in formal academic settings',
      ],
    }
  ),
  word('demure', '수줍은', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['demur', 'demean', 'mature'],
      definitionDistractors: [
        'to raise an objection or express reluctance about doing something',
        'showing extreme confidence and assertiveness in public settings',
        'having reached full physical or emotional development',
      ],
    }
  ),
  word('denigrate', '비난하다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['designate', 'delegate', 'detonate'],
      definitionDistractors: [
        'to officially appoint someone to a specific role or position',
        'to assign responsibility or authority to another person',
        'to publicly praise and honor someone for their achievements',
      ],
    }
  ),
  word('depravity', '타락', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['deprivation', 'gravity', 'bravery'],
      definitionDistractors: [
        'the state of being denied basic necessities or comforts',
        'a condition of extreme poverty and lack of resources',
        'the quality of showing outstanding moral character and virtue',
      ],
    }
  ),
  word('deride', '비웃다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['derived', 'decided', 'desired'],
      definitionDistractors: [
        'to obtain or receive something from a specific source',
        'to reach a firm conclusion after careful consideration',
        'to express deep admiration and respect for someone',
      ],
    }
  ),
  word('despondent', '낙담한', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['respondent', 'dependent', 'correspondent'],
      definitionDistractors: [
        'a person who replies to a survey or legal proceeding',
        'feeling mildly annoyed or irritated by a situation',
        'showing careful and responsible behavior in all matters',
      ],
    }
  ),
  word('despot', '독재자', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['depot', 'dessert', 'deposit'],
      definitionDistractors: [
        'a storage facility or station for goods and vehicles',
        'a person elected by popular vote to represent the people',
        'a generous benefactor who donates to charitable causes',
      ],
    }
  ),
  word('diatribe', '비난 연설', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['dialogue', 'diatonic', 'attribute'],
      definitionDistractors: [
        'a balanced and respectful exchange of ideas between two parties',
        'a short and concise summary of a complex topic',
        'a formal speech of praise delivered at a ceremony',
      ],
    }
  ),
  word('didactic', '교훈적인', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['dialectic', 'diagnostic', 'dynamic'],
      definitionDistractors: [
        'relating to logical reasoning through question and answer',
        'purely entertaining without any educational purpose',
        'capable of identifying the root cause of a problem',
      ],
    }
  ),
  word('dilatory', '지연하는', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['diluted', 'migratory', 'obligatory'],
      definitionDistractors: [
        'required by law or rule; mandatory and compulsory',
        'acting with great urgency and speed to complete a task',
        'weakened or reduced in strength by adding water or another substance',
      ],
    }
  ),
  word('dilettante', '아마추어', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['debutante', 'diligent', 'militant'],
      definitionDistractors: [
        'a young woman making her first formal appearance in society',
        'a dedicated specialist with deep expertise in one field',
        'a person who works tirelessly and with great persistence',
      ],
    }
  ),
  word('dirge', '장송곡', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['verge', 'gorge', 'surge'],
      definitionDistractors: [
        'a lively and upbeat musical composition for celebrations',
        'a sharp increase or sudden rush of energy or emotion',
        'the edge or border where two different areas meet',
      ],
    }
  ),
  word('disabuse', '오해를 풀다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['disavow', 'disarmed', 'disbursed'],
      definitionDistractors: [
        'to refuse to acknowledge or take responsibility for something',
        'to deliberately misinform or mislead someone about the facts',
        'to spread false information widely to confuse the public',
      ],
    }
  ),
  word('disaffected', '불만을 품은', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['disinfected', 'disaffirmed', 'unaffected'],
      definitionDistractors: [
        'cleaned and freed from harmful bacteria or contaminants',
        'showing no emotional response or reaction to events',
        'deeply committed and enthusiastically supportive of a cause',
      ],
    }
  ),
  word('discomfit', '당황시키다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['discomfort', 'disconcert', 'discount'],
      definitionDistractors: [
        'to provide physical ease and relief from pain',
        'to cause mild physical uneasiness or soreness',
        'to encourage and give confidence to someone who is nervous',
      ],
    }
  ),
  word('disparage', '폄하하다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['disparate', 'dispatch', 'displace'],
      definitionDistractors: [
        'to send off quickly to a destination or for a purpose',
        'to compare two fundamentally different things side by side',
        'to publicly commend and celebrate someone\'s accomplishments',
      ],
    }
  ),
  word('dissemble', '숨기다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['disassemble', 'resemble', 'ensemble'],
      definitionDistractors: [
        'to take apart a machine or structure into its component pieces',
        'to look or seem similar to another person or thing',
        'to openly express one\'s true feelings without reservation',
      ],
    }
  ),
  word('dissolute', '방탕한', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['dissolve', 'desolate', 'resolute'],
      definitionDistractors: [
        'determined and unwavering in purpose or belief',
        'to break down or melt into a liquid solution',
        'living a disciplined and morally upright lifestyle',
      ],
    }
  ),
  word('dogmatic', '독단적', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['pragmatic', 'dramatic', 'enigmatic'],
      definitionDistractors: [
        'dealing with things sensibly and practically rather than ideally',
        'open to new ideas and willing to change one\'s opinion',
  ...
  word('doleful', '슬픈', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['doubtful', 'dutiful', 'dolorous'],
      definitionDistractors: [
        'feeling uncertain or unsure about something',
        'conscientiously fulfilling one\'s obligations and responsibilities',
        'expressing bright optimism and cheerful contentment',
      ],
    }
  ),
  word('dotard', '망령든 노인', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['dastard', 'bastard', 'custard'],
      definitionDistractors: [
        'a cowardly person who avoids confrontation at all costs',
        'a young and energetic person full of vitality',
        'a wise and respected elder in a community',
      ],
    }
  ),
  word('draconian', '가혹한', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['draconic', 'dynastic', 'dramatic'],
      definitionDistractors: [
        'relating to mythical dragons or serpentine creatures',
        'fair and balanced in the application of rules and laws',
        'involving sudden and exciting changes or theatrical performances',
      ],
    }
  ),
  word('duplicitous', '이중적', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['duplicate', 'duplicity', 'dubious'],
      definitionDistractors: [
        'creating an exact copy or reproduction of something',
        'straightforward and transparent in all dealings with others',
        'existing in two identical forms simultaneously',
      ],
    }
  ),
  word('ebullient', '들뜬', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['emollient', 'turbulent', 'opulent'],
      definitionDistractors: [
        'having a soothing and softening effect on the skin',
        'characterized by disorder, conflict, and unpredictable change',
        'feeling deeply sad and withdrawn from social interaction',
      ],
    }
  ),
  word('ecclesiastical', '교회의', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['eclectic', 'electrical', 'elliptical'],
      definitionDistractors: [
        'deriving ideas or style from a broad range of diverse sources',
        'relating to government and political administration',
        'having an oval shape or following an indirect path',
      ],
    }
  ),
  word('effervescent', '기운찬', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['efflorescent', 'evanescent', 'fluorescent'],
      definitionDistractors: [
        'producing a bright glowing light through chemical reaction',
        'gradually fading and disappearing from view over time',
        'remaining still and motionless without any observable activity',
      ],
    }
  ),
  word('effigy', '인형', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['edifice', 'epitaph', 'affidavit'],
      definitionDistractors: [
        'a large and imposing building or architectural structure',
        'an inscription carved on a tombstone in memory of the dead',
        'a written account describing someone\'s life achievements',
      ],
    }
  ),
  word('effrontery', '뻔뻔함', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['affront', 'effluent', 'frontier'],
      definitionDistractors: [
        'the liquid waste discharged from a factory or sewage system',
        'a deep sense of shyness and reluctance to impose on others',
        'the boundary or edge of settled or explored territory',
      ],
    }
  ),
  word('egregious', '터무니없는', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['gregarious', 'exiguous', 'energetic'],
      definitionDistractors: [
        'fond of company and sociable in nature',
        'remarkably outstanding and worthy of great admiration',
        'very small or inadequate in amount or quantity',
      ],
    }
  ),
  word('elegy', '애가', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['eulogy', 'allergy', 'effigy'],
      definitionDistractors: [
        'a joyful hymn celebrating victory or achievement',
        'a formal speech expressing strong political opinions',
        'an adverse physical reaction to a substance or environment',
      ],
    }
  ),
  word('elucidate', '밝히다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['elude', 'illuminate', 'hallucinate'],
      definitionDistractors: [
        'to escape or avoid something by being quick or clever',
        'to deliberately obscure or complicate an explanation',
        'to experience vivid perceptions that are not real',
      ],
    }
  ),
  word('emaciate', '여위게 하다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['emancipate', 'emanate', 'eviscerate'],
      definitionDistractors: [
        'to set free from legal, social, or political restrictions',
        'to spread outward from a source of origin',
        'to build up and strengthen muscles through exercise',
      ],
    }
  ),
  word('embroil', '엮다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['embroider', 'embark', 'embrace'],
      definitionDistractors: [
        'to decorate fabric by sewing patterns with thread',
        'to begin a journey or start a new venture',
        'to free someone from a complicated or difficult situation',
      ],
    }
  ),
  word('empiricism', '경험주의', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['imperialism', 'criticism', 'optimism'],
      definitionDistractors: [
        'the policy of extending a nation\'s authority over foreign territories',
        'a belief system based purely on abstract reasoning and logic',
        'the practice of accepting traditional beliefs without questioning them',
      ],
    }
  ),
  word('ennui', '권태', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['envoy', 'ensue', 'annul'],
      definitionDistractors: [
        'a messenger or representative sent on a diplomatic mission',
        'intense excitement and passionate enthusiasm for an activity',
        'a strong feeling of anger or resentment toward someone',
      ],
    }
  ),
  word('epitome', '전형', 9, 'noun',
    ...
    }),
    {
      ...
      wordDistractors: ['epitaph', 'episode', 'epilogue'],
      definitionDistractors: [
        'an inscription on a tombstone commemorating the deceased',
        'a notable exception that contradicts a general rule',
        'the concluding section of a literary work or speech',
      ],
    }
  ),
  word('equivocate', '모호하게 말하다', 9, 'verb',
    ...
    }),
    {
      ...
      wordDistractors: ['equivalent', 'equestrian', 'evocative'],
      definitionDistractors: [
        'equal in value, amount, or function to something else',
        'to speak clearly and decisively without any ambiguity',
        'tending to bring strong images or feelings to mind',
      ],
    }
  ),
  word('evanescent', '순간적인', 9, 'adjective',
    ...
    }),
    {
      ...
      wordDistractors: ['effervescent', 'adolescent', 'iridescent'],
      definitionDistractors: [
        'displaying shimmering colors that change when seen from different angles',
        'lasting forever and never changing or deteriorating',
        'bubbling with lively enthusiasm and high spirits',
      ],
    }
  ),
];
